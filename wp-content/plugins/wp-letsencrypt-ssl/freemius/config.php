...
if (!defined('WP_FS__IS_HTTPS')) {
  define(
    ...
    (WP_FS__IS_HTTP_REQUEST &&
      ...
      (isset($_SERVER['HTTPS']) && 'on' == $_SERVER['HTTPS']) || (isset($_SERVER['SERVER_PORT']) && 443 == $_SERVER['SERVER_PORT'])
  );
}
...
if (!defined('WP_FS__IS_LOCALHOST')) {
  if (defined('WP_FS__LOCALHOST_IP')) {
    ...
    define(
      'WP_FS__IS_LOCALHOST',
      WP_FS__IS_HTTP_REQUEST &&
        is_string(WP_FS__REMOTE_ADDR) && (substr(WP_FS__REMOTE_ADDR, 0, 4) === '127.' ||
...
if (!defined('WP_FS__IS_NETWORK_ADMIN')) {
  define(
    ...
    is_multisite() && (is_network_admin() || ((defined('DOING_AJAX') && DOING_AJAX && (isset($_REQUEST['_fs_network_admin']) /*||
